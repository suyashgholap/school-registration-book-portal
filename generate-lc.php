...
<body>
    ...
    <div class="row1">
        ...
        <div class="columnz right">
            ...
            ?>            
            <form class="filter-form" action="generate-lc.php" method="post">
                <h2>Select Book</h2>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <?php if ($_SESSION['prev_id'] == 1 || $_SESSION['prev_id'] == 3) : ?>
                                            <a class="editst" target="_blank" href="./lc-form.php?id=<?php echo $row['student_id']; ?>&xyz=<?php echo $tbl; ?>&grn=<?php echo $row['student_grn']; ?>"><i class="fa fa-fw fa-lg fa-gears"></i> Generate LC</a>
                                        <?php endif; ?>
                                    </td>
                                </tr>
                            <?php endif; ?>

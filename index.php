                    ...
                    <?php if ($result->num_rows > 0) : ?>
                        <?php while ($row = $result->fetch_assoc()) : ?>
                            ...
                            <tr>
                                ...
                                <td>
                                    <a class="viewst" href="./view-student.php?id=<?php echo $row['student_id']; ?>&xyz=<?php echo $tbl; ?>"><i class="fa fa-fw fa-lg fa-eye"></i>View</a>
                                    <?php if ($_SESSION['prev_id'] == 1 || $_SESSION['prev_id'] == 3) : ?>
                                        <a class="editst" href="./edit-student.php?id=<?php echo $row['student_id']; ?>&xyz=<?php echo $tbl; ?>"><i class="fa fa-fw fa-lg fa-edit"></i>Edit</a>
                                    <?php endif; ?>
                                </td>
                            </tr>
                        <?php endwhile; ?>

...
<body>
    ...
    <div class="row1">
        ...
        <?php
            ...
            ?>            
            <form class="filter-form" action="generate-nirgam.php" method="post">
                <h2>Select Book</h2>
            ...
            <?php
                    ...
                    $result = $conn->query($sql);
                ?>
                <h2 style="text-align: center;">Selected Book : <?php echo "$tbl"; ?></h2>
                <br>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <?php if ($_SESSION['prev_id'] == 1 || $_SESSION['prev_id'] == 3) : ?>
                                            <a class="editst" target="_blank" href="./nirgam.php?id=<?php echo $row['student_id']; ?>&xyz=<?php echo $tbl; ?>&grn=<?php echo $row['student_grn']; ?>"><i class="fa fa-fw fa-lg fa-gears"></i> Generate Nirgam</a>
                                        <?php endif; ?>
                                    </td>
                                </tr>
                            <?php endif; ?>

...
<body>
    ...
    <div class="row1">
        ...
        <div class="columnz right">
            <?php
            $sql = "SELECT book_name,book_active FROM tbl_books;";
            $result = $conn->query($sql);
            ?>            
            <form class="filter-form" action="generate-lc-duplicate.php" method="post">
                <h2>Select Book</h2>
                ...
                <input class="col2" onclick="myFunction()" type="submit" class="btn" value="Submit">
            </form>
                <?php
                    $tbl = $_POST['books'];
                    $sql = "SELECT student_id,student_fname,student_mname,student_lname,student_grn,student_dob,student_sid,student_uid,student_gender,student_status FROM $tbl";
                    $result = $conn->query($sql);
                ?>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <?php if ($_SESSION['prev_id'] == 1 || $_SESSION['prev_id'] == 3) : ?>
                                            <a class="editst" target="_blank" href="./lc-duplicate.php?id=<?php echo $row['student_id']; ?>&xyz=<?php echo $tbl; ?>&grn=<?php echo $row['student_grn']; ?>"><i class="fa fa-fw fa-lg fa-gears"></i> Generate LC</a>
                                        <?php endif; ?>
                                    </td>
                                </tr>
                            <?php endif; ?>
